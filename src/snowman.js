...
let invalid = 'Invalid Entry! Please enter a letter.';
...
let lives = 10 ; //score. gives the player 10 chances to guess a letter//
while(remainingLetters > 0 && lives > 0){
  console.log(underScore.join(' ')); 
  console.log(guesses.join(','))
  console.log(`Lives left: ${lives}`); //displays the score//
